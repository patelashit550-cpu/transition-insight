...
Self-rule: the capacity of a single sentient being or a collection of them to govern without arbitrary external domination. Living well free of coercive authority and of machinery that steers you against your self-interest. Kibbutzim are an example of an autonomous collective living in harmony with ecology.
...
In ordinary and vocational speech: a strong inner summons to a kind of work or life; vocation as destiny rather than mere job. The configuration of qualities through which meaningful work serves both self-actualization and the commons — evidenced by flow and useful outcomes, not title alone.
...
In biology and toxicology: a beneficial response to low-dose stress that would harm at high dose. Here: drawing comfort from discomfort — virtue forged in turbulent flow as Praxis metabolizes what orthodoxy alone cannot.
...
In philosophy (Aristotle onward): informed practice — doing that embodies theory, not mere technique (*poiesis*) or idle contemplation. Here: fluid practice that loosens orthodoxy enough to explore the edge; it yields *firmitas*, lets *ki* flow, and turns Alpha toward Omega.
...
Corpus usage: a coded boundary of shared meaning (*semper idem*) within which we recognize one another and can evaluate exchange with those beyond it. Nested perimeters compose the body politic.
